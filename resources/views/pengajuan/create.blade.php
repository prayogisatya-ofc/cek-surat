        ...
        <div class="card bg-primary-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Tambah Surat</h4>
                        <nav aria-label="breadcrumb" style="--bs-breadcrumb-divider: '/'">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">Tambah Surat</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('pengajuan.store') }}" method="post" id="formPengajuan">
                    ...
                    <input type="hidden" name="warga_id" id="warga_id" value="{{ old('warga_id') }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="jenis_surat"
                                ...
                                placeholder="Contoh: Surat Pindah Domisili" value="{{ old('jenis_surat') }}">
                            @error('jenis_surat')
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        <input type="search" class="form-control" id="wargaSearch"
                            placeholder="Cari: nama atau NIK...">
                        <div class="small text-muted mt-1" id="wargaHint">
